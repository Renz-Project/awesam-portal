 <div class="modal fade" id="DAInventory{{$key}}" tabindex="-1" aria-labelledby="#DAInventory{{$key}}Label">
    <div class="modal-dialog modal-lg">
        <div class="modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-success" id="DAInventory{{$key}}Label">DA Low Inventory ({{$location['location_name']}})</h5>
