 <div class="modal fade" id="reduceStock-{{$key}}" tabindex="-1" aria-labelledby="newUserLabel">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-danger" id="newUserLabel">Reduce Stock</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method='POST' action='{{url('office-supplies/new-stock')}}' class="reduce-stock-form" enctype="multipart/form-data">
                     @csrf   
                     <div class="row g-3">
                        <div class="col-lg-12">
                            ...
                            <input type="hidden" name="type" value="outflow" required>
                            <div>
