...
<div class="row">
    ...
    <div class="col-lg-3">
                ...
                @if($lowStockReport->isEmpty())
                <div class="card">
                    <div class="card-body ">
                        <div class="p-3 text-center text-muted">
                            All inventories are well-stocked!
                        </div>
                    </div>
                </div>
                @else
                <div class="card stretch-card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Inventory Per Location (Low Inventory)</h4>
                    </div>
                    <div class="card-body stretch-card">
                        <div class="table-responsive table-card">
                            <table class="table align-middle table-bordered table-centered table-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href='' data-bs-toggle="modal" data-bs-target="#DAInventory{{$key}}">{{$lowStockReport->where('location_id',$location['location_id'])->count()}}</a></td>
                                        <td><a href='#' data-bs-toggle="modal" data-bs-target="#FdoInventory{{$key}}">{{$lowStockReportFdos->where('location_id',$location['location_id'])->count()}}</a></td>
                                    </tr>
